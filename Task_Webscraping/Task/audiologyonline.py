...
print('Extracting Date_time:',date_time)
# MongoDB setup
client = MongoClient('mongodb://localhost:27017/')
db = client[f'your_collection_Audiologist']
collection = db['your_collection_Audiologist']
...
def get_all_pages(doc_details):
    ...
    print("processing of row:",href_tag)
...
if __name__ == '__main__':
    ...
    country_code = search_countries['AT']
    scrape(country_code)
